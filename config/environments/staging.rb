...
#}
#
#PAPERCLIP_ADMIN_STORAGE_OPTIONS = {
#  :path => 'admin/:class/:attachment/:id/:style/:basename.:extension'
#}.merge(PAPERCLIP_STORAGE_OPTIONS)
#
#PAPERCLIP_CLIENT_STORAGE_OPTIONS = {
#  :path => 'client/:class/:attachment/:id/:style/:basename.:extension'
#}.merge(PAPERCLIP_STORAGE_OPTIONS)
#
#PAPERCLIP_IMAGES_STORAGE_OPTIONS = {
#  :path => 'public/:class/:attachment/:id/:style/:basename.:extension',
...
SITE_HOST_NAME = "staging.wickedstart.com"
...
SITE_BLOG_PATH = "/blog"
SITE_BLOG_RSS_URL = "https://staging.wickedstart.com/blog/?feed=networkrss"
...
TWITTER_WS_URL = "https://www.twitter.com/wickedstart"
FACEBOOK_WS_URL = "https://www.facebook.com/wickedstart"
LINKED_IN_WS_URL = "https://www.linkedin.com/groups?mostPopular=&gid=3277641"
YOU_TUBE_WS_URL = "https://www.youtube.com/user/WickedStart"
